...
import ids323.estudiantes.util.Factory;
...
public class XDropdownMenu<T> extends XButton {
    ...
    public void setPopupFactory(Factory<JPopupMenu> f) {
        this.popupFactory = f;
    }

    public void setPopupItemFactory(Factory<JMenuItem> f) {
        this.itemFactory = f;
    }

    public void addChoiceListener(ChoiceListener<T> l) {choiceListeners.add(l);}
